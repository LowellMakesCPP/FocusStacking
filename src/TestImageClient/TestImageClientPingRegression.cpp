/* This is a client that should be used for regession testing.
 *
 * It ends before all the data is read by the server. 
 * Reference issue 9: 
 * https://github.com/LowellMakesCPP/FocusStacking/issues/9
 */
